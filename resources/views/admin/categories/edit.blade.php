                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" name="is_active" id="is_active">
                            <option value="1" {{ $category->is_active == 'فعال' ? 'selected' : '' }}>فعال</option>
                            <option value="0" {{ $category->is_active == 'غیرفعال' ? 'selected' : '' }}>غیرفعال</option>
                        </select>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="attributes">ویژگی ها</label>
                        <select class="form-control" id="attributeSelect" name="attribute_ids[]" data-live-search="true"
                                multiple>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" id="attributeIsFilterSelect" name="attribute_is_filter_ids[]"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" id="variationSelect" name="variation_id" data-live-search="true">
